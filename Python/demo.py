...
def xml_full_signature():
    ...
    try:
        ...
        signature_starter.set_signature_element_location('//ls:signaturePlaceholder', XmlInsertionOptions.appendChild, nsm)
...
# ----------------------------------------------------------------------------------------------------------
@app.route('/xml-element-signature')
def xml_element_signature():
    ...
    try:
        ...
        # StandardSignaturePolicies.NFE_PADRAO_NACIONAL policy, the security context will default to PKI Brazil (ICP-Brasil)
        # signature_starter.security_context_id = StandardSecurityContexts.PKI_BRAZIL
        # Note: By changing the SecurityContext above you can accept only certificates from a certain PKI
...
# ----------------------------------------------------------------------------------------------------------
@app.route('/xml-signature-action', methods=['POST'])
