   ...
   return new Promise(function(resolve) {
      ...
      request.post(util.endpoint + 'Api/PadesSignatures/Open', {
         ...
         if (restPki.checkResponse(err, restRes, body, next)) {
            ...
            // ICP-Brasil logo on bottom-right corner of every page (except
            // on the page which will be created at the end of the document)
            pdfMark = {
               pageOption: 'AllPages',
               container: {
                  width: 1,
            ...
            // wil be created at the end of the document), rotated 90 degrees
            ...
            // Header "VERIFICAÇÃO DAS ASSINATURAS" centered between ICP-Brasil
            // logo and QR Code.
            element = {
               elementType: 'Text',
               relativeContainer: {
            ...
            // verification code above and the verification link.
            // below
            elementHeight = 2.5;
            element = {
               elementType: 'Text',
