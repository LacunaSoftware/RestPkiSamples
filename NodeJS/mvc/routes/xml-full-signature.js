...
router.get('/', function(req, res, next) {
   ...
   // for receiving the signature elements and start the signature process.
   let signatureStarter = new FullXmlSignatureStarter(Util.getRestPkiClient());

   // Set the XML to be signed, a sample XML document.
   signatureStarter.xmlToSign = Util.getSampleXmlPath();
