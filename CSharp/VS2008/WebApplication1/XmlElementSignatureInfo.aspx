<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="XmlElementSignatureInfo.aspx.cs" Inherits="WebApplication1.XmlElementSignatureInfo" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<p>File signed successfully! <a href="Download.aspx?file=<%= signatureFilename.Replace(".", "_") %>">Click here to download the signed file</a></p>
