...
namespace WebApplication1 {
	public static class PadesVisualElements {
		...
		public static PadesVisualPositioning GetVisualPositioning(int sampleNumber) {
			...
			switch (sampleNumber) {
				...
				case 1:
					...
					return PadesVisualPositioning.GetFootnote(Util.GetRestPkiClient(), null, null);

				case 2:
					// Example #2: get the footnote positioning preset and customize it
					var footnotePosition = PadesVisualPositioning.GetFootnote(Util.GetRestPkiClient(), null, null);
