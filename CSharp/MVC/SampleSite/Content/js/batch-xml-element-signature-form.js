...
var batchXmlElementSignatureForm = (function () {
    ...
    function startSignature(step) {
        ...
        $.ajax({
            url: 'BatchXmlElementSignature/Start',
            method: 'POST',
            data: {
                elementId: batchElemIds[step.elemId],
                fileId: step.fileId
            },
            dataType: 'json',
    ...
    function completeSignature(step) {
        ...
        $.ajax({
            url: 'BatchXmlElementSignature/Complete',
            method: 'POST',
            data: {
                token: step.token,
                fileId: step.fileId
    ...
    function onBatchCompleted(filename) {
        ...
        $('#signedFileLink').attr('href', 'Download/File/' + filename);
        $('#openSignatureLink').attr('href', 'OpenXmlSignature?userfile=' + filename);
