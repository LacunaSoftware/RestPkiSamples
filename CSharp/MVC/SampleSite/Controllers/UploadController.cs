...
namespace Lacuna.RestPki.SampleSite.Controllers {
	...
	/*
	 * This controller allows the user to upload a file to be signed. Once the file is uploaded, we save it to the
	 * App_Data folder and redirect the user to Index action on either CadesController or PadesController passing
	 * the filename on the "userfile" URL argument.
	 */
