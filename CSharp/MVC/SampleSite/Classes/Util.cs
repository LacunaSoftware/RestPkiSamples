...
namespace SampleSite.Classes {
	...
	public class Util {
		 ...
		 * 
		 * Security contexts dictate which root certification authorities are trusted during certificate
		 * validation. In your API calls, you can use one of the standard security contexts or reference
		 * one of your custom contexts.
		 */
