/*
 * This file contains the necessary calls to the Web PKI component. It is shared between the PAdES and CAdES signature
 * pages, as well as with the authentication page. It assumes the presence of certain HTML elements, such as the
 * "signForm" form, the "tokenInput" input, the "certificateSelect" combo box and the buttons "signButton" and
 * "refreshButton".
 */
