...
public class OpenPadesSignatureController {
    ...
    public String get(
        ...
        // configurations (valid values are 1-4). Once you decide which is best for your case, you can place the code
        // directly here.
    ...
    private static void setValidationParameters(PadesSignatureExplorer2 sigExplorer, int caseNumber) {
        ...
        switch (caseNumber) {
             ...
             * minimal security features defined in the PAdES standard (ETSI TS 102 778). The signatures need not,
