...
public class AuthenticationController {
	...
	public String post(
		...
		// certificate's fields, such as userCert.getEmailAddress() or userCert.getPkiBrazil().getCpf() (the actual
		// field to be used as key depends on your application's business logic) and set the user as authenticated with
		// whatever web security framework your application uses. For demonstration purposes, we'll just render the
