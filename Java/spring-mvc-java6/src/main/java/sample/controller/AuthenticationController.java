...
public class AuthenticationController {
	...
	public String post(
		...
		// Call the completeWithWebPki() method with the token (rendered in a hidden input field, see
		// file templates/authentication.html). This method finalizes the authentication process,
		// yielding a ValidationResults object which denotes whether the authentication was
		// successful or not.
		...
		if (!vr.isValid()) {
			...
			// performed, but the string contains tabs and new line characters for formatting, which
			// we'll convert to <br>'s and &nbsp;'s.
		...
		// application's business logic) and set the user as authenticated with whatever web security
		// framework your application uses. For demonstration purposes, we'll just render the user's
