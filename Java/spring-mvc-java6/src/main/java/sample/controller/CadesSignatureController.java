	...
	public String get(
		...
		if (userfile != null && !userfile.isEmpty()) {
			...
			/*
				...
				set the path to the CMS to be co-signed, which was previously saved in our temporary folder by the
				complete() method on this controller. Note two important things:

				1. The CMS to be co-signed must be set using the method "setCmsToCoSign", not the method
