...
public class FullXmlSignatureController {
	...
	public String get(
		...
		// signWithRestPki() method on the Web PKI component (see file static/js/signature-form.js) and also to complete
		// the signature after the form is submitted (see method complete() below). This should not be mistaken with the
		// API access token.
