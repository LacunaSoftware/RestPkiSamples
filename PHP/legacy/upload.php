 ...
 * "app-data" folder and redirect the user to the signature samples passing the filename on the "userfile" URL
 * argument.
 */
...
if (isset($_FILES['userfile'])) {
    ...
    // Redirect the user to the signature page, passing the name of the file as a URL argument.
