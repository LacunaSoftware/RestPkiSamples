...
use Lacuna\RestPki\Legacy\FullXmlSignatureStarter;
use Lacuna\RestPki\Legacy\StandardSignaturePolicies;
use Lacuna\RestPki\Legacy\XmlInsertionOptions;

// Get an instance of the FullXmlSignatureStarter class, responsible for receiving the signature elements and start the
// signature process.
...
// we call the function setNoCacheHeaders(), located on util.php, which sets HTTP headers to prevent caching of the
// page.
setNoCacheHeaders();
