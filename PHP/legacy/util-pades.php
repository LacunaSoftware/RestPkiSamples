...
use Lacuna\RestPki\Legacy\Color;
use Lacuna\RestPki\Legacy\PadesVisualPositioningPresets;
use Lacuna\RestPki\Legacy\PadesMeasurementUnits;
use Lacuna\RestPki\Legacy\PdfMark;
use Lacuna\RestPki\Legacy\PdfMarkImage;
use Lacuna\RestPki\Legacy\PdfMarkImageElement;
use Lacuna\RestPki\Legacy\PdfMarkTextElement;
use Lacuna\RestPki\Legacy\PdfTextSection;
use Lacuna\RestPki\Legacy\PdfTextStyle;

// This function is called by pades-signature.php and batch-signature-start.php. This function creates a visual
// representation for a PDF signature.
...
// This function is called by pades-signature.php and batch-signature-start.php. It contains examples of PDF marks,
// visual elements of arbitrary content placed in every page. This code is only in a separate function in order to
// organize the various examples, you can pick the one that best suits your needs and use it below directly without
