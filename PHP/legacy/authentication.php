...
// signWithRestPki() method on the Web PKI component (see signature-form.js) and also to call the completeWithWebPki()
...
// we call the function setNoCacheHeaders(), located in util.php, which sets HTTP headers to prevent caching of the page.
setNoCacheHeaders();
...
// to meet your application's needs. You can also bring into the javascript block below if you prefer.
?>
