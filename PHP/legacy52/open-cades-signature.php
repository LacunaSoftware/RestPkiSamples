...
function setValidationParameters($sigExplorer, $caseNumber) {
    switch ($caseNumber) {
        ...
        case 1:
            ...
            $sigExplorer->setAcceptableExplicitPolicies(RestPkiStandardSignaturePolicyCatalog::getPkiBrazilCades());
            break;
        ...
        case 2:
            ...
            // policy.
            $sigExplorer->setDefaultSignaturePolicyId(RestPkiStandardSignaturePolicies::CADES_BES);
        ...
        case 4:
            $sigExplorer->setAcceptableExplicitPolicies(
                RestPkiStandardSignaturePolicyCatalog::getPkiBrazilCadesWithSignerCertificateProtection());
            break;
        ...
        case 5:
            $sigExplorer->setAcceptableExplicitPolicies(
                RestPkiStandardSignaturePolicyCatalog::getPkiBrazilCadesWithCACertificateProtection());
            break;
    }
}
...
$sigExplorer = new RestPkiCadesSignatureExplorer(getRestPkiClient());
