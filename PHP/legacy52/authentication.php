...
// The file util.php contains the functions getRestPkiClient() and getSecurityContextId(), which gives us an instance of
// the RestPkiClient class initialized with the API access token.
require_once 'util.php';

// Get an instance of the RestPkiAuthentication class (see util.php).
$auth = new RestPkiAuthentication(getRestPkiClient());
...
// to meet your application's needs. You can also bring the code into the javascript block below if your prefer.
?>
<script src="content/js/signature-form.js"></script>
<script>
    $(document).ready(function () {        // Once the page is ready, we call the init() function on the javascript code (see signature-form.js).
        signatureForm.init({
